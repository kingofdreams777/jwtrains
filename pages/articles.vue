<template>
    <div class="flex place-content-center">
        <div class="prose text-left lg:prose-lg">
            <h1>How to order articles</h1>
            <ol>
                <li>
                    <p>
            ...
            <p><i>Addresses outside of the continental U.S. should check the <a href="http://ircalc.usps.gov/">international
                        postal calculator</a> for shipping costs. There

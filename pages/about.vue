    ...
    <div class="flex flex-col place-items-center">
        <div class="text-left prose">
            ...
            <p>Since I was a member of the Toy Train Operating Society, Southern Pacific Division, in Los Angeles, I began
                ...
                articles for maintenance and repair of differenting operating cars, accessories, transformers, locomotives,
                and tenders.</p>

            <p>I met Dave Otth through the TTOS and found we had a mutual interest in the production of videos for the
                repair of Lionel Model Trains. A partnership was formed where Dave produced the videos and I repaired trains
            ...
            <p>I've been working on the internet since it first became practical in the early 1980's. It finally evolved to
                a technology that offered unlimited opportunities for information dissemination and that interested me since
